# Classify
Web app that runs tensorflow and caffe at the backend to classify images. I use Inception in tensorflow and alexnet in caffe
...
# Alexnet trained on places dataset
  ...
  After you downloaded these two files please place them in the same folder and rename it as 'models_places' or replave the PlacesPath
